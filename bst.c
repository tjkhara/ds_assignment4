...
struct Node *_addNode(struct Node *cur, TYPE val)
{
    ...
    if(cur == NULL)
    {
        ...
        // Insert value
        t->val = val;
        // Set left and right equal to NULL
        t->left = t->right = NULL;
    ...
    {
        // Key is equal and already present
    }
...
int containsBSTree(struct BSTree *tree, TYPE val)
{
    ...
    // Pointer t starts from root
    struct Node* t = tree->root;
